...
@Primary
@Transactional
public class StudentService1 implements StudentServiceInter{

    private final StudentRepository studentRepository;
    private final UrlConfiguration urlConfiguration;
    private final RestTemplate restTemplate;

    public StudentService1(StudentRepository studentRepository, UrlConfiguration urlConfiguration, RestTemplate restTemplate) {
    ...
    public void getStudents(){
        ResponseEntity<StudentResponseDto[]> studentsResponseEntity = restTemplate.getForEntity(urlConfiguration
                .getStudentsUrl(), StudentResponseDto[].class);
